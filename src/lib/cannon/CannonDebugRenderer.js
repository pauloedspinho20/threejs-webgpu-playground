...
CannonDebugRenderer.prototype = {
    ...
    _createMesh: function(shape){
        ...
        case CANNON.Shape.types.CONVEXPOLYHEDRON:
            ...
            geo.setAttribute('position', new THREE.Float32BufferAttribute(convexPositions, 3));
        ...
        case CANNON.Shape.types.TRIMESH:
            ...
            for (var i = 0; i < shape.indices.length / 3; i++) {
                ...
                triPositions.push(v0.x, v0.y, v0.z, v1.x, v1.y, v1.z, v2.x, v2.y, v2.z);
            }
            ...
            for (var xi = 0; xi < shape.data.length - 1; xi++) {
                for (var yi = 0; yi < shape.data[xi].length - 1; yi++) {
                    for (var k = 0; k < 2; k++) {
                        ...
                        hfPositions.push(v0.x, v0.y, v0.z, v1.x, v1.y, v1.z, v2.x, v2.y, v2.z);
                    }
                }
            }
            var geometry = new THREE.BufferGeometry();
            geometry.setAttribute('position', new THREE.Float32BufferAttribute(hfPositions, 3));
            geometry.computeBoundingSphere();
            geometry.computeVertexNormals();
            mesh = new THREE.Mesh(geometry, purple);
            shape.geometryId = geometry.id;
